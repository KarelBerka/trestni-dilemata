...
const CRIMES_DATA = [
  ...
  {
    id: "kradez-prosta",
    name: "Krádež v základní sazbě",
    paragraph: "§ 205 odst. 1 písm. a) TZ",
    category: "Majetek",
    categoryLabel: "Trestné činy proti majetku",
    scenario: "Pachatel přestříhal zámek u stojanu před nádražím a odcizil uzamčené jízdní kolo v hodnotě 25 000 Kč (škoda nikoli nepatrná), které obratem prodal v zastavárně.",
    legalText: "Kdo si přisvojí cizí věc tím, že se jí zmocní, a způsobí tak na cizím majetku škodu nikoli nepatrnou (od 10 000 Kč), bude potrestán odnětím svobody až na dvě léta nebo peněžitým trestem.",
    statutoryMinYears: 0,
    statutoryMaxYears: 2,
  ...
  },
  {
    ...
    name: "Krádež vloupáním",
    paragraph: "§ 205 odst. 1 písm. b) TZ",
    category: "Majetek",
    categoryLabel: "Trestné činy proti majetku a soukromí",
    scenario: "Pachatel v noci vypáčil okno rodinného domu a z přízemí odcizil elektroniku, šperky a hotovost v celkové hodnotě 180 000 Kč.",
  ...
  {
    id: "podvod-velky",
    name: "Podvod velkého rozsahu",
    paragraph: "§ 209 odst. 1, 5 písm. a) TZ",
    category: "Majetek",
    categoryLabel: "Trestné činy proti majetku",
    scenario: "Organizovaná skupina telefonicky manipulovala desítky občanů smyšlenou historkou o ohrožených bankovních účtech a připravila je celkem o 15 milionů Kč (škoda velkého rozsahu nad 10 mil. Kč).",
  ...
  {
    id: "zpronevera-firma",
    name: "Zpronevěra se značnou škodou",
    paragraph: "§ 206 odst. 1, 4 písm. d) TZ",
    category: "Majetek",
    categoryLabel: "Trestné činy proti majetku",
    scenario: "Hlavní účetní středně velké výrobní firmy po dobu tří let systematicky přeposílala firemní prostředky na svůj soukromý účet a zpronevěřila 3,5 milionu Kč (značná škoda).",
    legalText: "Kdo si přisvojí cizí věc, která mu byla svěřena, a způsobí tím značnou škodu (od 1 mil. Kč), bude potrestán odnětím svobody na dvě léta až osm let.",
    statutoryMinYears: 2,
    statutoryMaxYears: 8,
  ...
  },
  {
    ...
    name: "Zkrácení daně velkého rozsahu",
    paragraph: "§ 240 odst. 1, 3 písm. a) TZ",
